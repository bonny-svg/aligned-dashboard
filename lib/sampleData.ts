...
export const SAMPLE_PROPERTIES: Property[] = [
  ...
  {
    id: "the-grove",
    name: "Pecan Grove Village",
    address: "5600 Pecan Valley Dr",
    city: "Corpus Christi",
    state: "TX",
    units: 264,
    occupancyPct: 95.5,
